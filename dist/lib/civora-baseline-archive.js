...
__modules["packages/document-control/archive.js"] = (() => {
const { ControlError, CONTROL_LIMITS } = __modules["packages/document-control/index.js"];
const { createAccessContext } = __modules["packages/access/index.js"];
...
async function exportBaselineArchive(state, baseline, repository, actorId, { signal, onProgress, maxBytes = 90 * 1024 * 1024 } = {}) {
...
return { exportBaselineArchive };
})();

export const { exportBaselineArchive } = __modules["packages/document-control/archive.js"];
