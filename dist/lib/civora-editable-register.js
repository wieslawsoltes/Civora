...
__modules["packages/document-control/register.js"] = (() => {
const { ControlError, CONTROL_LIMITS, canonical, validateMetadata, calendarDate } = __modules["packages/document-control/index.js"];
...
function metadataRegisterCSV(state, projectId, documentIds = null) {
...
function parseRegisterCSV(source) {
...
function previewMetadataRegister(state, projectId, source) {
...
return { metadataRegisterCSV, parseRegisterCSV, previewMetadataRegister };
})();

export const { metadataRegisterCSV, parseRegisterCSV, previewMetadataRegister } = __modules["packages/document-control/register.js"];
