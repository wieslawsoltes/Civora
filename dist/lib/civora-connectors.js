...
__modules["packages/connectors/index.js"] = (() => {
...
const CONNECTORS = { microsoft: MicrosoftStorage, google: GoogleDriveStorage, dropbox: DropboxStorage };

return { randomSecret, pkceChallenge, providerRequest, OAuthPKCE, MicrosoftStorage, GoogleDriveStorage, DropboxStorage, CONNECTORS };
})();

export const { randomSecret, pkceChallenge, providerRequest, OAuthPKCE, MicrosoftStorage, GoogleDriveStorage, DropboxStorage, CONNECTORS } = __modules["packages/connectors/index.js"];
