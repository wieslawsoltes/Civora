...
__modules["packages/filesystem/drop.js"] = (() => {
...
const { localError, relativePath, LOCAL_LIMITS } = __modules["packages/filesystem/index.js"];
function collectDroppedFiles(dataTransfer, { limit = 5000, signal } = {}) {
...
export const { collectDroppedFiles } = __modules["packages/filesystem/drop.js"];
