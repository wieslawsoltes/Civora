...
export const { SCHEMA_VERSION, STATES, ROLES, DomainError, uid, copy, currentVersion, userName, projectDocs, referencesOf, createEmptyWorkspace, applyCommand, applyScheduledAutomation, previewDocumentCopy, previewDocumentRename, previewDocumentMove, previewDocumentTransition, searchDocuments, validateWorkspace, csv } = __modules["packages/core/index.js"];
