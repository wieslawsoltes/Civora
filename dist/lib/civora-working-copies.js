...
__modules["packages/filesystem/working-copies.js"] = (() => {
/** Managed external-editor working copies, independent of the application UI. */
const { localFileBlob } = __modules["packages/filesystem/index.js"];
const { currentVersion, uid } = __modules["packages/core/index.js"];
const { canAccess } = __modules["packages/access/index.js"];
const { prepareFile, sha256 } = __modules["packages/storage/index.js"];
const { portableName, relativePath, joinPath, hashBlob, optionalRead, localError, isMissing } = __modules["packages/filesystem/index.js"];
function documentPermission(engine, permission, doc) {
...
function workingPath(state, doc) {
...
async function importTree(engine, entries, { projectId, folderId = null, revision = 'P01', discipline = 'General', metadata = {}, signal, onProgress } = {}) {
...
async function exportTree(engine, fs, documentIds, { basePath = '', signal, onProgress } = {}) {
...
return { documentPermission, workingPath, WorkingCopyManager, importTree, exportTree };
})();

export const { documentPermission, workingPath, WorkingCopyManager, importTree, exportTree } = __modules["packages/filesystem/working-copies.js"];
