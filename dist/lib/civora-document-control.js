...
export const { ControlError, METADATA_TYPES, METADATA_FORMATS, CONTROL_LIMITS, calendarDate, normalizeFields, validateMetadata, metadataIssues, normalizeNumbering, formatDocumentNumber, allocateDocumentNumber, dependencyClosure, documentPath, reviewContext, canonical, snapshotDocument, captureBaseline, liveBaseline, compareBaselines, normalizeReviewStages, currentReviewStage, pendingReviewers, reviewDocumentCurrent, reviewIsCurrent, recordStageDecision, validateControlState } = __modules["packages/document-control/index.js"];
