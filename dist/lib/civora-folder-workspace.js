...
__modules["packages/filesystem/repository.js"] = (() => {
...
const { applyCommand, validateWorkspace, copy, uid } = __modules["packages/core/index.js"];
const { hashBlob, optionalRead, localError, localFileBlob } = __modules["packages/filesystem/index.js"];
...
export const { DirectoryRepository } = __modules["packages/filesystem/repository.js"];
